...
\cvitem{Description}{
    ...
    to collect the training and testing data, and implemented the CNN using Python and PyTorch.
}
...
\cvitem{}{
    I'm able to learn new programming languages and technologies very quickly. When I was hired 
    to work at Concept Reply, I had never used Xcode or Objective-C and had never programmed 
    ...
    the data parser written in Java. Meanwhile, I was also starting to work on other backend projects 
    allowing me to start exploring different cloud platforms. 
    \newline{}
